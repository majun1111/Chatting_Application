...
public class client implements ActionListener {
    ...
    client() {
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("4.png"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("5.png"));
    ...
    public static void main(String[] args) {
        ...
        try {
            Socket s= new Socket("127.0.1",6001);
